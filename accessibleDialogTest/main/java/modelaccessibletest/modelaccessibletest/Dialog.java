...
public class Dialog {
		...
		public void checkFirstElementReceiveFocus(WebElement activeElement, WebElement street, String description) {
		   ...
		   public void checkFocusIsInvokingElement(WebElement elementToCheckFocus, Keys cancel, String description, WebDriver driver) {
		   ...
		   public void performFocusMaintenance(WebElement firstElement, WebElement lastElement, Keys tabKey, Keys shiftTabKey, int elementCount) throws InterruptedException {
			    Actions actions = new Actions(driver);
